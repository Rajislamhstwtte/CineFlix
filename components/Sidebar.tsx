...
import { CloseIcon, HomeIcon, TrendingIcon, ComingSoonIcon, CategoriesIcon, SettingsIcon, HelpIcon, UsersIcon, SunIcon, MoonIcon } from './IconComponents';
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, onNavigate, currentView, showToast, theme, toggleTheme, onOpenSettings }) => {
      ...
      >
        <div className="flex flex-col h-full p-5">
          ...
          <div className="flex-shrink-0 pt-4 space-y-2 border-t border-black/10 dark:border-gray-800 mt-4">
            ...
            <NavItem icon={<HelpIcon />} label="Help & Information" onClick={() => handleComingSoon('Help & Info')} />
          </div>
        </div>
      </aside>
    </>
